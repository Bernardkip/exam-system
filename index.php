	...
	if( !empty( $_POST )){
		try {
			...
			if(isset($_SESSION['logged_in']) && $_SESSION['logged_in']){
				$_SESSION['success'] = 'Login succesful.please proceed!!';
  ...
  <body>
	<div class="container">
		<div class="login-form">
			...
			<h1 class="text-center">QUICK Quiz system</h1>
			...
			<form id="login-form" method="post" class="form-signin" role="form" action="<?php echo $_SERVER['PHP_SELF']; ?>">
				...
				<button class="btn btn-block bt-login" type="submit">Log in</button>
			</form>
			<div class="form-footer">
				<div class="row">
					<div class="col-xs-6 col-sm-6 col-md-6">
						<i class="fa fa-lock"></i>
						<a href="forget_password.php"> want to reset password?? </a>
					
					</div>
					
					<div class="col-xs-6 col-sm-6 col-md-6">
						<i class="fa fa-check"></i>
						<a href="register.php">Are you a new??Sign Up </a>
					</div>
				</div>
			</div>
			<br/>
			<div class="text-center well">
				<p>example Email/Password: Bernardkip.gmail.com/kipchirchir</p>
			</div>
		</div>
	</div>
	<!-- /container -->
